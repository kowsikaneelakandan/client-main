  ...
  useEffect(() => {
    const fetchOfferListings = async () => {
      try {
        ...
        setOfferListings(res.data); // Directly access the data from the response
        fetchRentListings();
      } catch (error) {
        console.log(error);
      }
    ...
    const fetchRentListings = async () => {
      try {
        ...
        setRentListings(res.data); // Directly access the data from the response
        fetchSaleListings();
      } catch (error) {
        console.log(error);
      }
    ...
    const fetchSaleListings = async () => {
      try {
        ...
        setSaleListings(res.data); // Directly access the data from the response
      } catch (error) {
        console.log(error);
      }
    };
